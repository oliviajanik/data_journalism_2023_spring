...
Spotify_Youtube_clean_Q2 <- Spotify_Youtube_clean %>%
  mutate(stream_in_millions = (stream/1000000)) %>%
    ...
    valence <= 0.2 ~ "0-0.2",
    valence <= 0.4 ~ "0.2-0.4",
    danceability <= 0.6 ~ "0.4-0.6",
    danceability <= 0.8 ~ "0.6-0.8",
    danceability <= 1 ~ "0.8-1",
    )) %>%
