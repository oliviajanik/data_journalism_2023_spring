...
**Answer** The function lists all the unique words in the text column, but differentiates by capitalization and punctuation.
...
**Answer** There are 64,7091 words, all in lowercase.
...
**Answer** No. The most common words are filler words like articles and conjunctions, not words that tell us anything about what Cardin is saying.
...
**Answer** Yes. These words are relatively more interesting and more relevant to learning about what Cardin is working on. Common words here are health, support, project and act. So they are not incredibly descriptive still.
...
**Answer** In 2021, the word covid is the fifth most mentioned word, but it does not appear in the top 10 in 2022 or 2023. Words like health, act and legislation appear frequently. But in 2023, words including women, rights and fire jump into the top 10 most used.
...
**Task** Run the following code and describe the results.
**Answer** The most popular phrase is "covid 19" and the second is "human rights." These answers make sense because both have been key issues the past couple of years.
...
**Task** Run the following code and describe the results.
**Answer** The answers are different in the just 2022 releases. The top phrase is "project location" and second is "amount included" which probably indicate Cardin is discussing economic projects in the state.
...
**Task** Run the following code and describe the results.
**Answer** In 2023, the top answer is "human rights" and the second is "equal rights." The most intriguing phrases in the top 10 list are "oral health" and "offshore wind."
...
**Answer** In 2021, Cardin mentions "trump" 86 times and its says it has a positive connotation, but Cardin was likely talking about the president, not using the verb trump. Another issue appears in 2023, with the word supreme, which is likely in conjunction with court, in reference to the Supreme Court, which is a proper noun with no positive or negative connotation.
