...
**Answer** There are two columns, the date the press release is sent out and the title of the press release.
...
**Answer** Having the url to the press release itself as a column.
...
**Answer** There appear to be 122 <li> tags on this webpage.
...
**Answer** The first 16 tags are menu items for the page. The press releases begin at row 17.
...
**Answer** There is only one column and all the information is in there. The menu items also appear in the dataframe.
