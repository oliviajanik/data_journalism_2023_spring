...
**Answer** 55632 observations of seven variables.
...
**Answer** "id" is character data "seats" is numeric.
...
**Answer** The first line states the data we are using. The second line says we are grouping the data by the term. The third line says we are counting classes in that term.
...
**Answer** The number of courses per term is sorted from highest to lowest.
...
**Answer** This output shows us how not just how many classes their are in a term, but also how many classes each department has per term.
...
Compared to the previous codeblock, what has changed and how did that affect the result? 
**Answer** This output does not include the departments, but rather includes how many courses are available and the total seats available that term from highest to lowest.
...
Compared to the previous codeblock, what has changed and how did that affect the result? What do the top terms have in common? This output still includes the seat count per term, but also includes descriptive statistics. The median and mean are included in this chart.
**Answer**
...
**Answer** Building on the last output, this spreadsheet further sorts the data by classes and seats per department. It also includes the mean, median, maximum and minimum. 
...
1.  What department has the most courses each term? Does it stay the same?

2.  Is the number of available seats per term increasing or decreasing?

3.  What departments offer courses with high seat couts? Do any departments have low seat counts on a majority of its classes?
