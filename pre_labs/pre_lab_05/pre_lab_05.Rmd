...
**Answer** One problem is that the Maryland data column is used as the header row. Another is that the periods in the first row are still present.
...
**Answer** There are still numbers as the column names instead of the years that should be there.
...
**Answer** We need to remove the periods from the entries in the first column.
