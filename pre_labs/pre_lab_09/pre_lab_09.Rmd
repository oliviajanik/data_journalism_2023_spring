...
https://www.datawrapper.de/_/ZBB6G/
...
md_gov_county <- md_gov_county %>% 
  ...
  mutate(pctmoore = (Moore/total_votes)*100)
...
Now, the map only includes the state of Maryland, rather than the entire country. The color scale is greyscale and the state is tilted to best fit on the chart.
...
**Answer** Describe the changes from the previous map
Now if you hover over a county it provides the name rather than the fips code and give's Moore's percent of the vote in a percentage with a rounded number. The color legend also says "Wes Moore's percent of vote" to let viewers know what they are looking at.
...
https://www.datawrapper.de/_/WVvv1/
