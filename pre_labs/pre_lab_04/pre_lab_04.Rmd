...
**Task** Run the following code to group and count records in the Grantee column, and filter to examine only recipients that start with W. Name a problem that you see that is preventing proper grouping. **Answer** There is a typo with Washington County Commissioners, one entry says Washington County Commissione, which is most likely the same thing, but it ends up in a separate column. 
...
**Answer** The refinr package changed Charles County Arts Alliance Inc to CHARLES COUNTY ARTS ALLIANCE. Most of the grantee results in the first 3 pages stayed the same.
...
**Task** Run the following code to group by grantee_clean and Grantee, then filter for recipients that start with W. Name three changes the refinr function made in the first 30 results. **Answer** The refinr function did not fix some of the previous issues that were identified in the data. The WASHINGTON CO COMMISSIONE entry stayed in the column and the WASHINGTON CO COMMUNITY A did not merge with WASHINGTON CO COMMUNITY ACTION COUNCIL. There were not three changes made to the first 30 results.
...
**Answer** The new version does not make any major changes to the data from the function ran in task 6. There are still 376 rows of data.
