...
```{r echo=FALSE}
census_api_key("0c9e4a42e64dc44c0efda2561d52d008a3ffd85d", install=TRUE)
```
...
**Answer** Howard County is the richest county in Maryland according to median income, with a median income of 129,549.
...
**Answer** Howard County, wealthiest county in Maryland
...
Is the difference between Calvert and Montgomery significant? **Answer** No, because the margin of error overlaps.

Is the difference between Howard and everyone else significant? **Answer** Yes, because Howard County's margin of error does not overlap with any of the margins of other counties.
...
**Answer** Baltimore city had the highes growth of median income by 37%.
...
**Answer** What is the college enrollment percentage in zip codes where the median household income is 100,000 or more?
...
**Answer** The average median income for high schools that have 60% or more graduates immediately enrolling in college is 111,448.3. The median income for high schools with less than 40% of graduates immediately enrolled in college is 69,252.24.
...
**Answer** What is the percent of students who immediately enroll in college from schools with 500 or more students per graduation class?
